...
class SmoothColorCircleRenderObject(NovaRenderObject):
    def __init__(self, app, ctx):
        super().__init__(app, ctx, "engine/scripts/renderer/shaders/vertex/smoothSolidCircle.vert", "engine/scripts/renderer/shaders/fragment/smoothSolidCircle.frag", np.float32, 3, 6, NOVA_SOLID_CIRCLE_BATCH_SIZE)
